...
class SaveLoadButton(QComboBox):
    ...
    def saveGame(self):
        try:
            ...
            if file_path:
                game_state = self.mainWidget.getGameState()  # Assuming mainWidget has a method to get the game state
    ...
    def loadGame(self):
        try:
            ...
            if file_path:
                ...
                self.mainWidget.setGameState(game_state)  # Assuming mainWidget has a method to set the game state
